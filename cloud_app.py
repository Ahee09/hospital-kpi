...
if df is not None:
    ...
    with col_right:
        ...
        # Sắp xếp dữ liệu theo số lượng bệnh nhân để đường line chạy mượt từ trái sang phải
df_sorted = final_df.sort_values(by='Benh_Nhan')
        ...
        fig_trend = px.scatter(
            ...
            title="Dự báo tương quan Doanh thu - Bệnh nhân (AI Regression Model)"
)
        # Thêm đường line kết nối các điểm dữ liệu thực tế
        fig_trend.add_traces(list(px.line(df_sorted, x='Benh_Nhan', y='Doanh_Thu').data))
